...
#
print 'Polynomial fit when Lambda is 0.....'
Lambda = 0
theta = trainLinearReg(X_poly, y, Lambda, method='BFGS', maxiter=10)

# Plot training data and fit
plt.figure()
plt.scatter(X, y, marker='o', s=10, edgecolor='r', lw=1.5)
...
plt.legend('original data', 'plotFitdata')
plt.title('Polynomial Regression Fit (Lambda = %0.4f)' % Lambda)
raw_input("Program paused. Press Enter to continue...") 
...
plt.title('Polynomial Regression Learning Curve (Lambda = %0.4f)' % Lambda)
plt.xlabel('Number of training examples')
plt.ylabel('Error')
plt.xlim(0, 13)
plt.ylim(0, 150)
...
print 'Polynomial fit when Lambda is 1.....'
Lambda_T1 = 1
theta = trainLinearReg(X_poly, y, Lambda_T1, method='BFGS', maxiter=10)
plt.figure()
plt.scatter(X, y, marker='o', s=10, edgecolor='r', lw=1.5)
...
plt.ylabel('Water flowing out of the dam (y)')     # Set the x-axis label
plt.legend('original data', 'plotFitdata')
plt.title('Polynomial Regression Fit (Lambda = %0.4f)' % Lambda_T1)
raw_input("Program paused. Press Enter to continue...") 

plt.figure()
error_train, error_val = learningCurve(X_poly, y, X_poly_val, yval, Lambda_T1)
plt.plot(range(m), error_train, label='Train')
plt.plot(range(m), error_val, label='Cross Validation')
plt.title('Polynomial Regression Learning Curve (Lambda = %0.4f)' % Lambda_T1)
plt.xlabel('Number of training examples')
plt.ylabel('Error')
plt.xlim(0, 13)
plt.ylim(0, 150)
...
print 'Polynomial fit when Lambda is 100.....'
Lambda_T2 = 100
theta = trainLinearReg(X_poly, y, Lambda_T2, method='BFGS', maxiter=10)
plt.figure()
plt.scatter(X, y, marker='o', s=10, edgecolor='r', lw=1.5)
...
plt.ylabel('Water flowing out of the dam (y)')     # Set the x-axis label
plt.legend('original data', 'plotFitdata')
plt.title('Polynomial Regression Fit (Lambda = %0.4f)' % Lambda_T2)
